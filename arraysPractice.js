...
var getRandomArbitrary = function() {
  var randomNum = Math.floor(Math.random() * (30 - 0) + 0);
};
...
function addItem(myGroceryList, str2) {
  myGroceryList.push(str2);
  return myGroceryList;
}
